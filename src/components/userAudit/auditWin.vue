    ...
    <el-dialog title="详情" :visible.sync="auditWinVisible" @update:visible="cancel" width="50%">
        ...
        <div v-if="applicationContent.content.type=='add'" class="newMsg">
            ...
            <el-form :label-position="rightPosition" label-width="80px">
                <div class="addInput" v-for="(value, key) in applicationContent.content.message.newMsg" v-if="key!='pwd'"
                    v-bind:key="key">
        ...
        <div v-if="applicationContent.content.type=='update'" class="updateWin">
            <el-form :label-position="labelPosition" label-width="80px">
                ...
                <div v-for="(value, key) in applicationContent.content.message.oldMsg" v-if="key!='pwd'" v-bind:key="key">
                    <el-form-item :label="key">
                        <el-input :value="value" disabled></el-input>
                    </el-form-item>
                </div>
            ...
            <el-form :label-position="labelPosition" label-width="80px">
                ...
                <div v-for="(value, key) in applicationContent.content.message.newMsg" v-if="key!='pwd'" v-bind:key="key">
                    <el-form-item :label="key">
                        <el-input :value="value" disabled></el-input>
                    </el-form-item>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            ok() {
                ...
                this.updateApplication({id:this.applicationContent._id,handle:"1",passed:this.radio});//修改application集合状态
                this.updateUserPassed({id:this.applicationContent.content.workId,passed:this.radio});//修改user用户passed
                if(this.applicationContent.content.type=="add"&&this.radio=="1"){
                    this.addOwners({id:this.applicationContent.content.workId});
                }
            },
            cancel() {
                this.setauditWinVisible(false);
